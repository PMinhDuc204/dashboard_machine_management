    ...
    ((d = function () {
      ...
      (c.sparkline_display_visible = function () {
        ...
        for (b = 0, d = H.length; b < d; b++)
          ((a = H[b][0]),
            c(a).is(":visible") && !c(a).parents().is(":hidden")
              ? (H[b][1].call(a),
        ...
        getTagSetting: function (a) {
          ...
          if (this.tagValCache.hasOwnProperty(a)) b = this.tagValCache.key;
            ...
            if (void 0 === (b = this.tag.getAttribute(f + a)) || null === b)
              ...
              for (
                d = b.substr(1, b.length - 2).split(","), b = {}, c = d.length;
                c--;
              )
                ((e = d[c].split(":", 2)),
      ...
      (c.fn.sparkline._base = e({
        ...
        setRegionHighlight: function (a, b, c) {
          ...
          return b > this.canvasWidth || c > this.canvasHeight || b < 0 || c < 0
            ? null
      ...
      (c.fn.sparkline.line = u =
        e(c.fn.sparkline._base, {
          type: "line",
      ...
      (c.fn.sparkline.bar = v =
        e(c.fn.sparkline._base, t, {
          type: "bar",

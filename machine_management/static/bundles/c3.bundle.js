(!(function (a, b) {
      ...
      function d(a, b) {
        ...
        for (var c = 1; c < b.length; c++)
          if (
            ...
            return d(a.concat(b.substr(0, f || c)), b.slice(f ? f + 1 : c));
        return a.concat(b);
      }
      var e,
        f,
      ...
      function a(e) {
        e.each(function () {
          ...
          switch (b.orient) {
            ...
            case "left":
              ((e = b.axisY),
                p.attr("x2", -b.innerTickSize).attr("y1", g).attr("y2", g),
                q
                  .attr("x", -b.tickLength)
                  .attr("y", b.tickOffset)
                  .style("text-anchor", "end"),
                r.attr("x", -b.tickLength).attr("dy", function (a, c) {
                  return b.tspanDy(a, c);
                }),
                t.attr(
                  "d",
  ...
  var z = (function (b) {
    function c(b) {
      ...
      var f = { fn: d, internal: { fn: e } },
        g = j(
          this,
          (c.__proto__ || Object.getPrototypeOf(c)).call(this, b, "axis", f),
        );
  ...
  (((d = z.prototype).init = function () {
    ...
    (d.getLabelPosition = function (a, b) {
      var c = this.getLabelOptionByAxisId(a),
        d =
          c && "object" === (void 0 === c ? "undefined" : g(c)) && c.position
            ? c.position
            : b;
      return {
    ...
    (d.getMaxTickWidth = function (a, b) {
      ...
      return b && g.currentMaxTickWidths[a]
        ...
        : (g.svg &&
          ...
          (g.currentMaxTickWidths[a] = i <= 0 ? g.currentMaxTickWidths[a] : i),
          g.currentMaxTickWidths[a]);
    }),
  ...
  return (
      ...
      ((d.axis = new z(d)),
        ...
        g.data_hide &&
          d.addHiddenTargetIds(
            !0 === g.data_hide ? d.mapToIds(d.data.targets) : g.data_hide,
          ),
        g.legend_hide &&
          d.addHiddenLegendIds(
            !0 === g.legend_hide ? d.mapToIds(d.data.targets) : g.legend_hide,
          ),
        ...
        d.initRegion(),
        d.initGrid(),
        c.append("g").attr("clip-path", d.clipPath).attr("class", f.chart),
    ...
    (B.transformMain = function (a, b) {
      ...
      (b && b.axisX
        ? (c = b.axisX)
        : ((c = g.main.select("." + f.axisX)), a && (c = c.transition())),
        b && b.axisY
          ? (d = b.axisY)
          : ((d = g.main.select("." + f.axisY)), a && (d = d.transition())),
        b && b.axisY2
          ? (e = b.axisY2)
          : ((e = g.main.select("." + f.axisY2)), a && (e = e.transition())),
        ...
        ? (b = new MutationObserver(function (d) {
            d.forEach(function (d) {
              "childList" === d.type &&
                d.previousSibling &&
                (b.disconnect(),
                (c.intervalForObserveInserted = window.setInterval(function () {
                  a.node().parentNode &&
                    (window.clearInterval(c.intervalForObserveInserted),
                    c.updateDimension(),
    ...
    (B.bindResize = function () {
      ...
      if (
        ...
        b.resize_auto &&
          a.resizeFunction.add(function () {
            (void 0 !== a.resizeTimeout && window.clearTimeout(a.resizeTimeout),
        ...
        (c
          ? (c.add && c.remove) || (c = a.generateResize()).add(window.onresize)
          : (c = a.generateResize()),
      ...
      return (
        a instanceof Date
          ...
          : "string" == typeof a
            ...
            : "object" === (void 0 === a ? "undefined" : g(a))
              ? (b = new Date(+a))
              : "number" != typeof a || isNaN(a) || (b = new Date(+a)),
        (b && !isNaN(+b)) ||
          window.console.error("Failed to parse x '" + a + "' to Date object"),
        b
      );
    }),
    ...
    "SVGPathSeg" in window ||
      ...
      "getPathSegAtLength" in window.SVGPathElement.prototype ||
        (window.SVGPathElement.prototype.getPathSegAtLength = function (a) {
      ...
      ((b = i.convertDataToTargets(c, !0)),
            ...
            if (a.id === b[c].id) {
              for (
                ...
                ((b[c].values[d].index = n + d),
                  i.isTimeSeries() || (b[c].values[d].x = n + d));
        ...
        i.data.targets.forEach(function (a) {
          ...
          for (b = 0; b < j.length; b++)
            if (a.id === j[b])
              for (
                n = a.values[a.values.length - 1].index + 1, c = 0;
                c < m;
                c++
              )
                a.values.push({
          ...
          d
            ...
            .each(function () {
              (C.add(b.axes.x.transition().call(b.xAxis)),
                ...
                C.add(
                  F.filter(b.isRegionOnX).transition().attr("transform", g),
                ),
        ...
        a.data
          ? d.isMultipleX()
            ? ((c = [d.x(a.data.x), d.getYScale(a.data.id)(a.data.value)]),
              (b = null))
            : (b = k(a.data.index) ? a.data.index : d.getIndexByX(a.data.x))
          : void 0 !== a.x
            ? (b = d.getIndexByX(a.x))
    ...
    (B.updateAngle = function (a) {
      ...
      return g
        ? (f.pie(f.filterTargetsToShow(f.data.targets)).forEach(function (b) {
            (h || b.data.id !== a.data.id || ((h = !0), ((a = b).index = i)),
              i++);
          }),
      ...
      c.transiting
        ? (b = window.setInterval(function () {
            c.transiting ||
              ...
              c.legend.selectAll(".c3-legend-item-focused").size() > 0 &&
                c.expandArc(a));
          }, 10))
        : ((a = c.mapToTargetIds(a)),
          c.svg
    ...
    (B.meetsArcLabelThreshold = function (a) {
      ...
      return (
        a >=
        (b.hasType("donut") ? c.donut_label_threshold : c.pie_label_threshold)
      );
    }),
    ...
    (B.redrawArc = function (a, b, c) {
      ...
      ((d = i
        ...
        .style("cursor", function (a) {
          return h.interaction_enabled && h.data_selection_isselectable(a)
            ? "pointer"
            : null;
        })
        .each(function (a) {
        ...
        e.hasType("gauge") &&
          (e.arcs.select("." + f.chartArcsBackground).attr("d", function () {
            var a = {
          ...
          e.arcs
            ...
            .attr(
              ...
              -1 *
                (e.innerRadius +
                  (e.radius - e.innerRadius) / (h.gauge_fullCircle ? 1 : 2)) +
                "px",
            )
            .attr("dy", "1.2em")
            .text(
              h.gauge_label_show ? e.textForGaugeMinMax(h.gauge_min, !1) : "",
            ),
          e.arcs
            ...
            .attr("dy", "1.2em")
            .text(
              h.gauge_label_show ? e.textForGaugeMinMax(h.gauge_max, !0) : "",
            )));
    }),
    ...
    (B.classRegion = function (a, b) {
      return (
        this.generateClass(f.region, b) + " " + ("class" in a ? a.class : "")
      );
    }),
    ...
    (B.convertRowsToData = function (a) {
      for (var b = [], c = a[0], d = 1; d < a.length; d++) {
        for (var e = {}, f = 0; f < a[d].length; f++) {
          if (void 0 === a[d][f])
            throw new Error(
              "Source data is missing a component at (" + d + "," + f + ")!",
            );
          e[c[f]] = a[d][f];
        }
        b.push(e);
    ...
    (B.convertColumnsToData = function (a) {
      for (var b = [], c = 0; c < a.length; c++)
        for (var d = a[c][0], e = 1; e < a[c].length; e++) {
          if ((void 0 === b[e - 1] && (b[e - 1] = {}), void 0 === a[c][e]))
            throw new Error(
              "Source data is missing a component at (" + c + "," + e + ")!",
            );
          b[e - 1][d] = a[c][e];
        }
      return b;
          ...
          return {
            ...
            values: a
              .map(function (a, g) {
                ...
                return (
                  d.isCustomX() && d.isCategorized() && void 0 !== i
                    ? (0 === c && 0 === g && (e.axis_x_categories = []),
                      -1 === (h = e.axis_x_categories.indexOf(i)) &&
                        ((h = e.axis_x_categories.length),
                        e.axis_x_categories.push(i)))
                    : (h = d.generateTargetX(i, b, g)),
                  (void 0 === a[b] || d.data.xs[b].length <= g) && (h = void 0),
                  { x: h, value: j, id: f }
                );
              })
              .filter(function (a) {
    ...
    (B.orderTargets = function (a) {
      ...
      return (
        b &&
          (a.sort(b), (this.isOrderAsc() || this.isOrderDesc()) && a.reverse()),
        a
      );
    }),
            ...
            a.forEach(function (a) {
              ((c.withoutFadeIn[a] = !1),
                c.legend &&
                  c.legend
                    .selectAll(
                      "." + f.legendItem + c.getTargetSelectorSuffix(a),
                    )
                    .remove(),
      ...
      return (
        ...
        0 === r.length
          ...
          : (isNaN(w) && (w = 0),
            ...
            (f = g = 0.1 * e),
            void 0 !== y &&
              ((x = y + (h = Math.max(Math.abs(w), Math.abs(x)))), (w = y - h)),
            B
              ? ((i = o.getDataLabelLength(w, x, "width")),
                (j = s(o.y.range())),
                (f += e * ((l = [i[0] / j, i[1] / j])[1] / (1 - l[0] - l[1]))),
                (g += e * (l[0] / (1 - l[0] - l[1]))))
              : C &&
            ...
            "y" === b &&
              u(p.axis_y_padding) &&
              ((f = o.axis.getPadding(p.axis_y_padding, "top", f, e)),
              (g = o.axis.getPadding(p.axis_y_padding, "bottom", g, e))),
            "y2" === b &&
              u(p.axis_y2_padding) &&
              ((f = o.axis.getPadding(p.axis_y2_padding, "top", f, e)),
              (g = o.axis.getPadding(p.axis_y2_padding, "bottom", g, e))),
            z && (m && (g = w), n && (f = -x)),
            (d = [w - g, x + f]),
            A ? d.reverse() : d)
      );
    ...
    (B.getXDomainPadding = function (a) {
      ...
      return (
        ...
        "object" === g(h.axis_x_padding) && u(h.axis_x_padding)
          ? ((d = k(h.axis_x_padding.left) ? h.axis_x_padding.left : c),
            (e = k(h.axis_x_padding.right) ? h.axis_x_padding.right : c))
          : (d = e =
              "number" == typeof h.axis_x_padding ? h.axis_x_padding : c),
        { left: d, right: e }
      );
    }),
    ...
    (B.updateXDomain = function (a, b, c, d, e) {
      ...
      return (
        ...
        b &&
          (f.x.domain(
            e ||
              (!f.brush || f.brush.empty() ? f.orgXDomain : f.brush.extent()),
          ),
          g.zoom_enabled && f.zoom.scale(f.x).updateScaleExtent()),
        ...
        (l.data_selection_enabled &&
          ((l.zoom_enabled && !k.zoom.altDomain) ||
            (l.data_selection_multiple &&
              ...
              (g = Math.min(b, d)),
              (h = Math.max(b, d)),
              (i = l.data_selection_grouped ? k.margin.top : Math.min(c, e)),
    ...
    (B.yFormat = function (a) {
      var b = this,
        c = b.config;
      return (
        c.axis_y_tick_format ? c.axis_y_tick_format : b.defaultValueFormat
      )(a);
    }),
    (B.y2Format = function (a) {
      var b = this,
        c = b.config;
      return (
        c.axis_y2_tick_format ? c.axis_y2_tick_format : b.defaultValueFormat
      )(a);
    }),
    ...
    (B.updateGrid = function (a) {
      ...
      (e.grid.style("visibility", e.hasArcType() ? "hidden" : "visible"),
        ...
        e.ygridLines
          ...
          .attr(
            "x",
            h.axis_rotated ? e.xGridTextX.bind(e) : e.yGridTextX.bind(e),
          )
          .attr("y", d)
          .text(function (a) {
            return a.text;
      ...
      a.append("rect")
        ...
        .on("mouseover", function (a) {
          ...
          b.dragging ||
            ...
            b.main.selectAll("." + f.shape + "-" + c).each(function (a) {
                  ...
                  (c.select(this).classed(f.EXPANDED, !0),
                    ...
                    d.tooltip_grouped ||
                      ...
                      d.data_selection_grouped ||
                        (b.unexpandCircles(g), b.unexpandBars(g))));
                })
                .filter(function (a) {
          ...
          !b.hasArcType() &&
            ...
            (b.cancelClick
              ...
              : (b.isStepType(a) &&
                  ...
                  (e -= 1),
                b.main.selectAll("." + f.shape + "-" + e).each(function (a) {
          ...
          c.dragging ||
            ...
            g
              ? ((h = (
                ...
                c.showXGridFocus(h),
                (c.isBarType(g.id) || c.dist(g, a) < e.point_sensitivity) &&
                  (c.svg.select("." + f.eventRect).style("cursor", "pointer"),
                  c.mouseover ||
                    (e.data_onmouseover.call(c.api, g), (c.mouseover = g))))
              : b());
        })
        .on("click", function () {
          var a,
          ...
          c.hasArcType(g) ||
            ...
            (b = c.findClosestFromTargets(g, a)) &&
              ...
              c.main
                .selectAll("." + f.shapes + c.getTargetSelectorSuffix(b.id))
      ...
      ((a = c.mapToTargetIds(a)),
        c.legend
          ...
          .style("opacity", function () {
            return (b ? c.opacityForLegend : c.opacityForUnfocusedLegend).call(
              c,
              c.d3.select(this),
            );
          }));
          ...
          .on("click", function (a) {
            y.legend_item_onclick
              ...
              : x.d3.event.altKey
                ...
                : (x.api.toggle(a),
                  x.isTargetToShow(a) ? x.api.focus(a) : x.api.revert());
          })
          .on("mouseover", function (a) {
            y.legend_item_onmouseover
              ? y.legend_item_onmouseover.call(x, a)
              : (x.d3.select(this).classed(f.legendItemFocused, !0),
                !x.transiting && x.isTargetToShow(a) && x.api.focus(a));
          })
          .on("mouseout", function (a) {
            y.legend_item_onmouseout
              ? y.legend_item_onmouseout.call(x, a)
              : (x.d3.select(this).classed(f.legendItemFocused, !1),
                x.api.revert());
          }))
          .append("text")
          .text(function (a) {
    ...
    (B.selectPoint = function (a, b, c) {
      ...
      (e.data_onselected.call(d.api, b, a.node()),
        d.main
          .select("." + f.selectedCircles + d.getTargetSelectorSuffix(b.id))
    ...
    (B.getBars = function (a, b) {
      ...
      return (
        b
          ? c.main.selectAll("." + f.bars + c.getTargetSelectorSuffix(b))
          : c.main
    ...
    (B.updateTargetsForLine = function (a) {
      ...
      ((b = c.main
        ...
        a.forEach(function (a) {
          c.main
            .selectAll(
              "." + f.selectedCircles + c.getTargetSelectorSuffix(a.id),
            )
    ...
    (B.lineWithRegions = function (a, b, c, d) {
      ...
      for (
        ...
        if (
          ...
          for (
            i = q.getScale(a[f - 1].x + t, a[f].x + t, q.isTimeSeries()),
              j = q.getScale(a[f - 1].value, a[f].value),
              k = b(a[f].x) - b(a[f - 1].x),
              l = c(a[f].value) - c(a[f - 1].value),
              n = 2 * (m = 2 / Math.sqrt(Math.pow(k, 2) + Math.pow(l, 2))),
              g = m;
            g <= 1;
            g += n
          )
    ...
    (B.getCircles = function (a, b) {
      ...
      return (
        b
          ? c.main.selectAll("." + f.circles + c.getTargetSelectorSuffix(b))
          : c.main
    ...
    (B.transformContext = function (a, b) {
      ...
      (b && b.axisSubX
        ? (c = b.axisSubX)
        : ((c = d.context.select("." + f.axisX)), a && (c = c.transition())),
    ...
    (B.getTooltipContent = function (a, b, c, d) {
      ...
      for (p && a.sort(p), f = 0; f < a.length; f++)
        if (
          ...
          void 0 !== (h = x(o(a[f].value, a[f].ratio, a[f].id, a[f].index, a))))
        ) {
          ...
          : ((e = j.getSvgLeft(!0)),
            k.axis_rotated
              ? ((g = (f = e + n[0] + 100) + b),
                ...
                (h = j.x(a[0].x) + 20))
              : ((g =
                  (f = e + j.getCurrentPaddingLeft(!0) + j.x(a[0].x) + 20) + b),
  ...
  (function () {
    ...
    function xa(a, b, c) {
      ...
      return la(
        116 * e - 16,
        500 * (d - e),
        200 * (e - pa((0.0193339 * a + 0.119192 * b + 0.9503041 * c) / Zg)),
      );
    }
    function ya(a) {
      ...
      function b(a) {
        function b(b) {
          for (var c, e, f, g = [], h = -1, i = 0; ++h < d; )
            37 === a.charCodeAt(h) &&
              (g.push(a.slice(i, h)),
              null != (e = mh[(c = a.charAt(++h))]) && (c = a.charAt(++h)),
                ...
                : "W" in d || "U" in d
                  ? ("w" in d || (d.w = "W" in d ? 1 : 0),
                    ...
                    f.setFullYear(
                      ...
                      0,
                      "W" in d
                        ? ((d.w + 6) % 7) + 7 * d.W - ((f.getDay() + 5) % 7)
                        : d.w + 7 * d.U - ((f.getDay() + 6) % 7),
                    ))
      ...
      function c(a, b, c, d) {
        for (var e, f, g, h = 0, i = b.length, j = c.length; i > h; ) {
          ...
          if (37 === (e = b.charCodeAt(h++))) {
            if (
              ((g = b.charAt(h++)),
              !(f = D[g in mh ? b.charAt(h++) : g]) || (d = f(a, c, d)) < 0)
            )
              return -1;
        ...
        if (k)
          for (
            ...
            var r = a[0],
              ...
              z = o * t;
            if (
              (uh.add(Math.atan2(z * w * Math.sin(x), p * u + z * Math.cos(x))),
              (f += y ? v + w * Lg : v),
              y ^ (m >= c) ^ (r >= c))
            ) {
              var A = rb(pb(l), pb(a));
    ...
    function Vc(a) {
      var b = a.circle;
      b &&
        (b.P || (ci = b.N), di.remove(b), fi.push(b), cd(b), (a.circle = null));
    }
    function Wc(a) {
      for (
        var b, c = _h, d = Qb(a[0][0], a[0][1], a[1][0], a[1][1]), e = c.length;
        e--;
      )
        ((b = c[e]),
          (!Xc(b, a) ||
    ...
    function gd(a, b) {
      ...
      for (_h = [], ai = new Array(a.length), bi = new bd(), di = new bd(); ; )
        if (((e = ci), f && (!e || f.y < e.y || (f.y === e.y && f.x < e.x))))
          ((f.x === c && f.y === d) ||
    ...
    function Ld(a) {
      ...
      (b[0] * c[1] < c[0] * b[1] &&
        ((b[0] *= -1), (b[1] *= -1), (d *= -1), (e *= -1)),
        (this.rotate =
          (d ? Math.atan2(b[1], b[0]) : Math.atan2(-c[0], c[1])) * Pg),
    ...
    function tf(a) {
      ...
      return (
        ...
        (b.interpolate = function (a) {
          return arguments.length
            ? ((g =
                "function" == typeof a ? (f = a) : (f = Ci.get(a) || uf).key),
              b)
            : g;
        }),
    ...
    function Pf(a) {
      ...
      return (
        ...
        (b.interpolate = function (a) {
          return arguments.length
            ? ((i =
                "function" == typeof a ? (h = a) : (h = Ci.get(a) || uf).key),
              (j = h.reverse || h),
              (k = h.closed ? "M" : "L"),
              b)
            : i;
    ...
    ((hg.bisectLeft = qg.left),
      ...
      (hg.pairs = function (a) {
        for (
          var b = 0, c = a.length - 1, d = a[0], e = new Array(0 > c ? 0 : c);
          c > b;
        )
          e[b] = [d, (d = a[++b])];
        return e;
    ...
    ((hg.selection.enter = S),
      ...
      (hg.select = function (b) {
        ...
        return (
          "string" == typeof b
            ? ((c = [xg(b, kg)]), (c.parentNode = kg.documentElement))
      ...
      (hg.selectAll = function (a) {
        ...
        return (
          "string" == typeof a
            ? ((b = jg(yg(a, kg))), (b.parentNode = kg.documentElement))
      ...
      (hg.behavior.zoom = function () {
        ...
        function m() {
          ...
          function b() {
            ...
            for (
              var c = hg.event.changedTouches, e = 0, f = c.length;
              f > e;
              ++e
            )
        ...
        function n() {
          ...
          (s
            ? clearTimeout(s)
            : (Li.call(this), (p = c((q = r || hg.mouse(this)))), i(a)),
    ...
    ((jh.year = Oa(
      ...
      [
        ...
        var c = (jh[a] = Oa(
          function (a) {
            return (
              (a = jh.day(a)).setDate(a.getDate() - ((a.getDay() + b) % 7)),
              a
            );
          },
          function (a, b) {
          ...
          function (a) {
            ...
            return (
              Math.floor((jh.dayOfYear(a) + ((c + b) % 7)) / 7) - (c !== b)
            );
          },
        ));
        ((jh[a + "s"] = c.range),
    ...
    ((hg.interpolate = sd),
      (hg.interpolators = [
        function (a, b) {
          ...
          return (
            "string" === c
              ? ah.has(b.toLowerCase()) || /^(#|rgb\(|hsl\()/i.test(b)
                ? od
                : rd
              : b instanceof ga
                ? od
    ...
    hg.layout.stack = function () {
      ...
      return (
        ...
        (a.order = function (b) {
          return arguments.length
            ? ((c = "function" == typeof b ? b : ri.get(b) || ne), a)
            : c;
        }),
        (a.offset = function (b) {
          return arguments.length
            ? ((d = "function" == typeof b ? b : si.get(b) || oe), a)
            : d;
        }),
        (a.x = function (b) {
          return arguments.length ? ((f = b), a) : f;
    ...
    ((Ag.transition = function (a) {
      for (
        var b,
          ...
          e = $f(a),
          f = [],
          g = Ki || { time: Date.now(), ease: zd, delay: 0, duration: 250 },
          h = -1,
          i = this.length;
        ++h < i;
      ) {
      ...
      (Mi.each = function (a, b) {
        ...
        if (arguments.length < 2) {
          ...
          R(this, function (e) {
            var f = e[d][c];
            (
              f.event || (f.event = hg.dispatch("start", "end", "interrupt"))
            ).on(a, b);
          });
        return this;
      }),
      ...
      function a(b) {
        b.each(function () {
          ...
          var i,
            ...
            m = hg.transition(g);
          (j &&
            ((i = Re(j)), m.attr("x", i[0]).attr("width", i[1] - i[0]), d(l)),
            k &&
              ((i = Re(k)),
